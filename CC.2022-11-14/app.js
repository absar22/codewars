...
function reversePokemon(value){
  return value.reverse()
}
console.log(reversePokemon(['pikachu', 'balbasaur', 'dragonite', 'togopie', 'charmender', 'chikorita']))
...
function sumNumbers(value){
  ...
  return value.reduce((acc, c) => acc + Number(c), 0)
